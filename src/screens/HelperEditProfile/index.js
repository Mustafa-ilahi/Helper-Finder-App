...
export default function HelperEditProfile({navigation, route}) {
  const {userImg, firstNamee, lastNamee, userEmaill, userPhonee} = route.params;
  ...
  const [userEmail, setUserEmail] = useState(userEmaill);
